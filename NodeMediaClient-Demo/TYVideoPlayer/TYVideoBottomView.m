...
- (void)addFullScreenBtn
{
    ...
    [fullScreenBtn setImage:[UIImage imageNamed:@"TYVideoPlayer.bundle/player_p2l"] forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    if([self isOrientationPortrait]) {
        [_fullScreenBtn setImage:[UIImage imageNamed:@"TYVideoPlayer.bundle/player_p2l"] forState:UIControlStateNormal];
    } else {
        [_fullScreenBtn setImage:[UIImage imageNamed:@"TYVideoPlayer.bundle/player_l2p"] forState:UIControlStateNormal];
    }
